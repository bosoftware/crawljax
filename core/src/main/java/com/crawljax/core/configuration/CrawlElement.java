 ...
 * HTML elements in the DOM that match the specified tag name. 1) &lt;a
 * class="foo" .. 2) &lt;div... 3) &lt;a href="http:// CrawlElement
 * exampleCrawlElement = new CrawlElement("a") represents the elements 1 and 3
 * You can refine the set of elements a CrawlElement represents by specifying
 * attributes and XPath conditions For example, you can refine
 * exampleCrawlElement to represent only element 1 using
...
public final class CrawlElement {
	...
	/**
	 * To create a CrawlElement representing an HTML element
	 * &lt;a&gt;MyLink&lt;/a&gt; the tag name would be "a".
	 * 
	 * @param eventType
	 ...
	 * attribute. For example &lt;div class="foo"&gt;... &lt;div
	 * class="bar"&gt;.. &lt;/div&gt; &lt;/div&gt; withAtttribute("class",
	 * "foo") Would restrict this CrawlElement to only include the div with
	 * class="foo"... AttributeName and value strings can support wild-card
	 * characters. Use % in to represent a wild-card string. e.g (% is the regex
	 * .*) When withAttribute() is called multiple times the CrawlElement will
	 * match only those HTML elements that have all the specified attributes.
	 * 
	 * @param attributeName
	...
	public CrawlElement withAttribute(String attributeName, String value) {
		if (this.underXpath == null || this.underXpath.isEmpty()) {
			...
			this.underXpath = this.underXpath + " | " + "//" + this.tagName
					+ "[@" + attributeName + "='" + value + "']";
		}
		return this;
	}
	 ...
	 * restrictions of this CrawlElement For example: &lt;HTML&gt; &lt;BODY&gt;
	 * &lt;DIV id="foo"&gt; &lt;SPAN id="bar"&gt; &lt;A...&gt;&lt;/A&gt;
	 * &lt;/SPAN&gt; &lt;/DIV&gt; .. //DIV[@id='foo'] includes the div, span and
	 * a elements //SPAN[@id='foo'] includes the span and a elements
	 * //DIV[@class='link'] will not include any elements IMPORTANT: In the
	 * xpath expression write elements in uppercase and attributes in lowercase
	 * 
	 ...
	 * text For example 1) &lt;a&gt;Foo&lt;/a&gt; 2) &lt;a&gt;Bar&lt;/a&gt; 3)
	 * &lt;a&gt;Example 3a&lt;/a&gt; withText("Foo") will include element 1
	 * withText("Example %") will include elements3 Text can support wild-card
	 * characters. Use % in to represent a wild-card string. e.g (% is the regex
	 * .*)
	 * 
	 * @param text
